...
$forgives_select_sql = "SELECT * FROM forgives";
$forgives = $db->query($forgives_select_sql)->fetch_all();


$tours_select_sql = "SELECT * FROM tours";
$tours = $db->query($tours_select_sql)->fetch_all();


$gallerys_select_sql = "SELECT * FROM gallerys";
$gallerys = $db->query($gallerys_select_sql)->fetch_all();
