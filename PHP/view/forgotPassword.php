    ...
    <div class="w3l_grid">
      <form action="" method="post" id="login">
        <div class="form-group">
          ...
          <input type="text" name="text"  class="form-control" id="text" placeholder="Enter email/phone number of your account...">
        </div>
        <div class="col-md-12 text-center ">
          <button type="submit" name="submit" class=" btn btn-block mybtn btn-primary tx-tfm">Search</button>
        </div>
      </form>
      <div class="col-md-12 text-center ">
       ...
       <div class="bottom-text w3_bottom_text">
        <p>Remember?<a href="login.php">Login</a></p>
        <h4> <a href="register.php">Create new account?</a></h4>
      </div>
