	...
	<form method="post" style="display: flex; justify-content: space-between;">
			...
			<div style="display: flex; margin-right: 30px">
				...
				<?php } 
						...
						<button type="button" id="log-out" name="log-out" onclick="logOut()">LOGOUT</button>	 		
				<?php } 
		...
		<div class="container" style="border: 1px solid black">
			...
			<p class="font-weight-bold">FOOD</p>
				...
				<?php for ($i=0; $i < count($food_select); $i++) { ?>	
								<div class="col-md-4">
									<div class="card mb-2">
										<img class="card-img-top" src="<?php  echo $food_select[$i][2] ?>"
										alt="Card image cap">
										<div class="card-body">
											<h4 class="card-title"><?php  echo $food_select[$i][1] ?></h4>
											<p class="card-text"><?php  echo $food_select[$i][4] ?></p>
											<a class="btn btn-primary" style="color: white">Order</a>
										</div>
									</div>
								</div>								
					<?php } ?>
